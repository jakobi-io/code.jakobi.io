    ...
    fetchData = (token) => {
        ...
        .then(data => {
            if (data.success) {
                ...
                // change window title
                document.title = (data.result.description !== "" ? this.decryptBase64(data.result.description) : "Untitled") + " | " + process.env.REACT_APP_TITLE;
            } else {
                // todo: handle error
                this.setState({ error: true })
            }
            ...
            if (this.state.error) {
                return <div className="error">
                    <div className="container center flex column">
                        <svg width="512" height="421" viewBox="0 0 512 421" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g>
                                ...
                                <path d="M16 421C7.168 421 0 413.832 0 405V330.333C0 309.747 16.7467 293 37.3333 293H69.3333C78.1653 293 85.3333 300.168 85.3333 309C85.3333 317.832 78.1653 325 69.3333 325H37.3333C34.3893 325 32 327.389 32 330.333V405C32 413.832 24.832 421 16 421Z" fill="#222222"/>
                                <path d="M69.3333 378.333H16C7.168 378.333 0 371.165 0 362.333C0 353.501 7.168 346.333 16 346.333H69.3333C78.1653 346.333 85.3333 353.501 85.3333 362.333C85.3333 371.165 78.1653 378.333 69.3333 378.333Z" fill="#222222"/>
                                ...
                                <path d="M496 59.9467V75.9467H16V59.9467C16 26.88 42.88 0 75.9467 0H436.053C469.12 0 496 26.88 496 59.9467V59.9467Z" fill="#C4C4C4" fill-opacity="0.2"/>
                            </g>
                            <defs>
                                <clipPath id="clip0">
